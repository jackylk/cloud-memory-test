...
1. **AWS Bedrock KB (Aurora PostgreSQL Serverless Serverless)**：基于 Aurora PostgreSQL Serverless Serverless v2 + pgvector，完整 SQL、ACID 事务，成本低，需 VPC。
...
|--------|----------|----------|----------|-----------|
| AWSBedrockKB-OpenSearch | 636.08 | 2056.87 | 2316.39 | 1006.45 |
| AWSBedrockKB-Aurora | 642.70 | 1594.33 | 1773.85 | 884.48 |
| VolcengineVikingDB | 882.44 | 1104.39 | 1118.25 | 860.88 |
| AlibabaBailian | 2180.80 | 4342.66 | 4707.48 | 2345.33 |

### 吞吐对比

| 知识库 | QPS | 总请求数 | 成功率 |
|--------|-----|----------|--------|
| AWSBedrockKB-OpenSearch | 0.95 | 5 | 100.0% |
| AWSBedrockKB-Aurora | 1.10 | 5 | 100.0% |
| VolcengineVikingDB | 0.86 | 5 | 100.0% |
| AlibabaBailian | 0.42 | 5 | 100.0% |
...
| VolcengineVikingDB | 0.600 | 0.620 | 1.041 |
| AlibabaBailian | 0.400 | 0.400 | 0.360 |
...
|--------|---------|---------|-----|-----|-----|---------|
| AWSBedrockKB-OpenSearch | 636.08ms | 2056.87ms | 0.95 | 0.800 | 0.800 | 0.631 |
| AWSBedrockKB-Aurora | 642.70ms | 1594.33ms | 1.10 | 0.400 | 0.480 | 0.604 |
| VolcengineVikingDB | 882.44ms | 1104.39ms | 0.86 | 0.600 | 0.620 | 1.041 |
| AlibabaBailian | 2180.80ms | 4342.66ms | 0.42 | 0.400 | 0.400 | 0.360 |
### 🏆 综合评分对比
...
2. 🥈 **VolcengineVikingDB** - MRR: 0.620, P@1: 0.600
3. 🥉 **AWSBedrockKB-Aurora** - MRR: 0.480, P@1: 0.400
4. **AlibabaBailian** - MRR: 0.400, P@1: 0.400

### ⚡ 性能特点总结

- **最快响应**: AWSBedrockKB-OpenSearch (P50: 636.08ms)
...
| 场景 | 推荐知识库 | 说明 |
|------|------------|------|
| **成本优先、已有 RDS** | AWS Bedrock (Aurora PostgreSQL Serverless Serverless) | 约 $44/月，完整 SQL、ACID，适合低中查询量。 |
