...
1. **AWS Bedrock KB (Aurora PostgreSQL)**：基于 Aurora PostgreSQL Serverless v2 + pgvector，完整 SQL、ACID 事务，成本低，需 VPC。
...
|--------|----------|----------|----------|-----------|
| AWSBedrockKB-OpenSearch | 600.62 | 1507.24 | 1686.89 | 820.37 |
| AWSBedrockKB-Aurora | 669.01 | 1705.15 | 1904.82 | 932.65 |
| VolcengineVikingDB | 903.15 | 1450.14 | 1544.86 | 904.72 |
| AlibabaBailian | 1027.98 | 2649.58 | 2935.61 | 1403.63 |

### 吞吐对比

| 知识库 | QPS | 总请求数 | 成功率 |
|--------|-----|----------|--------|
| AWSBedrockKB-OpenSearch | 1.15 | 5 | 100.0% |
| AWSBedrockKB-Aurora | 1.05 | 5 | 100.0% |
| VolcengineVikingDB | 0.84 | 5 | 100.0% |
| AlibabaBailian | 0.70 | 5 | 100.0% |
...
| VolcengineVikingDB | 0.000 | 0.064 | 0.064 |
...
|--------|---------|---------|-----|-----|-----|---------|
| AWSBedrockKB-OpenSearch | 600.62ms | 1507.24ms | 1.15 | 0.800 | 0.800 | 0.631 |
| AWSBedrockKB-Aurora | 669.01ms | 1705.15ms | 1.05 | 0.400 | 0.480 | 0.604 |
| VolcengineVikingDB | 903.15ms | 1450.14ms | 0.84 | 0.000 | 0.064 | 0.064 |
| AlibabaBailian | 1027.98ms | 2649.58ms | 0.70 | 0.600 | 0.600 | 0.590 |
### 🏆 综合评分对比
...
4. **VolcengineVikingDB** - MRR: 0.064, P@1: 0.000

### ⚡ 性能特点总结

- **最快响应**: AWSBedrockKB-OpenSearch (P50: 600.62ms)
...
| 场景 | 推荐知识库 | 说明 |
|------|------------|------|
| **成本优先、已有 RDS** | AWS Bedrock (Aurora PG) | 约 $44/月，完整 SQL、ACID，适合低中查询量。 |
