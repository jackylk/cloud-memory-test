...
|------|--------|--------------|-----------|
| 🥇 | AWSBedrockKB-OpenSearch | 1390.78 | +0.00ms |
| 🥈 | VolcengineVikingDB | 1632.08 | +241.30ms |
| 🥉 | AWSBedrockKB-Aurora | 5122.33 | +3731.55ms |
| 4 | AlibabaBailian | 11002.78 | +9612.00ms |

#### 2️⃣ 服务端处理时延P95对比（排除网络）

| 排名 | 知识库 | 网络基线P95 (ms) | 服务端P95 (ms) | 与最优差距 |
|------|--------|------------------|----------------|-----------|
| 🥇 | AWSBedrockKB-OpenSearch | 1251.86 | 1140.87 | +0.00ms |
| 🥈 | VolcengineVikingDB | 590.36 | 1621.82 | +480.95ms |
| 🥉 | AWSBedrockKB-Aurora | 1248.36 | 4815.58 | +3674.71ms |
| 4 | AlibabaBailian | 58.62 | 10958.87 | +9818.00ms |
...
|------|--------|-----|--------|-----------|
| 🥇 | VolcengineVikingDB | 0.75 | 100.0% | 0.0% |
| 🥈 | AWSBedrockKB-OpenSearch | 0.49 | 100.0% | -34.7% |
| 🥉 | AWSBedrockKB-Aurora | 0.19 | 100.0% | -74.7% |
| 4 | AlibabaBailian | 0.12 | 100.0% | -84.0% |
...
| 🥈 | AWSBedrockKB-Aurora | 0.480 | 0.400 | 0.604 |
| 🥉 | VolcengineVikingDB | 0.420 | 0.400 | 0.804 |
| 4 | AlibabaBailian | 0.229 | 0.200 | 0.396 |
...
|--------|---------|---------|-----|-----|-----|---------|
| AWSBedrockKB-OpenSearch | 634.50ms | 1390.78ms | 0.49 | 0.800 | 0.800 | 0.631 |
| AWSBedrockKB-Aurora | 3917.70ms | 5122.33ms | 0.19 | 0.400 | 0.480 | 0.604 |
| VolcengineVikingDB | 795.40ms | 1632.08ms | 0.75 | 0.400 | 0.420 | 0.804 |
| AlibabaBailian | 8792.16ms | 11002.78ms | 0.12 | 0.200 | 0.229 | 0.396 |
### 🏆 综合评分对比
...
2. 🥈 **AWSBedrockKB-Aurora** - MRR: 0.480, P@1: 0.400
3. 🥉 **VolcengineVikingDB** - MRR: 0.420, P@1: 0.400
4. **AlibabaBailian** - MRR: 0.229, P@1: 0.200

### ⚡ 性能特点总结

- **最快响应**: AWSBedrockKB-OpenSearch (P50: 634.50ms)
