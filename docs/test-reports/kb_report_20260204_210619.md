...
|------|--------|--------------|-----------|
| 🥇 | VolcengineVikingDB | 1413.65 | +0.00ms |
| 🥈 | AWSBedrockKB-Aurora | 1610.44 | +196.79ms |
| 🥉 | AWSBedrockKB-OpenSearch | 1718.07 | +304.42ms |
| 4 | AlibabaBailian | 8482.55 | +7068.90ms |

#### 2️⃣ 服务端处理时延P95对比（排除网络）

| 排名 | 知识库 | 网络基线P95 (ms) | 服务端P95 (ms) | 与最优差距 |
|------|--------|------------------|----------------|-----------|
| 🥇 | AWSBedrockKB-Aurora | 2254.00 | 1357.91 | +0.00ms |
| 🥈 | VolcengineVikingDB | 10.62 | 1404.10 | +46.18ms |
| 🥉 | AWSBedrockKB-OpenSearch | 1246.27 | 1470.57 | +112.65ms |
| 4 | AlibabaBailian | 44.13 | 8438.98 | +7081.06ms |
...
|------|--------|-----|--------|-----------|
| 🥇 | VolcengineVikingDB | 0.78 | 100.0% | 0.0% |
| 🥈 | AWSBedrockKB-OpenSearch | 0.57 | 100.0% | -26.9% |
| 🥉 | AWSBedrockKB-Aurora | 0.52 | 100.0% | -33.3% |
| 4 | AlibabaBailian | 0.26 | 100.0% | -66.7% |
...
| 4 | AlibabaBailian | 0.200 | 0.200 | 0.348 |
...
|--------|---------|---------|-----|-----|-----|---------|
| AWSBedrockKB-OpenSearch | 914.13ms | 1718.07ms | 0.57 | 0.800 | 0.800 | 0.631 |
| AWSBedrockKB-Aurora | 710.51ms | 1610.44ms | 0.52 | 0.400 | 0.480 | 0.604 |
| VolcengineVikingDB | 1022.04ms | 1413.65ms | 0.78 | 0.400 | 0.420 | 0.804 |
| AlibabaBailian | 2570.03ms | 8482.55ms | 0.26 | 0.200 | 0.200 | 0.348 |
### 🏆 综合评分对比
...
4. **AlibabaBailian** - MRR: 0.200, P@1: 0.200

### ⚡ 性能特点总结

- **最快响应**: AWSBedrockKB-Aurora (P50: 710.51ms)
