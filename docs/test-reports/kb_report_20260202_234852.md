...
|------|--------|--------------|-----------|
| 🥇 | AWSBedrockKB-OpenSearch | 1486.60 | +0.00ms |
| 🥈 | VolcengineVikingDB | 1820.70 | +334.10ms |
| 🥉 | AWSBedrockKB-Aurora | 2448.36 | +961.76ms |
| 4 | AlibabaBailian | 11234.43 | +9747.83ms |

#### 2️⃣ 服务端处理时延P95对比（排除网络）

| 排名 | 知识库 | 网络基线P95 (ms) | 服务端P95 (ms) | 与最优差距 |
|------|--------|------------------|----------------|-----------|
| 🥇 | AWSBedrockKB-OpenSearch | 1243.72 | 1239.60 | +0.00ms |
| 🥈 | VolcengineVikingDB | 19.98 | 1810.69 | +571.10ms |
| 🥉 | AWSBedrockKB-Aurora | 1247.44 | 2199.51 | +959.91ms |
| 4 | AlibabaBailian | 79.54 | 11190.14 | +9950.54ms |
...
|------|--------|-----|--------|-----------|
| 🥇 | VolcengineVikingDB | 0.64 | 100.0% | 0.0% |
| 🥈 | AWSBedrockKB-OpenSearch | 0.61 | 100.0% | -4.7% |
| 🥉 | AWSBedrockKB-Aurora | 0.53 | 100.0% | -17.2% |
| 4 | AlibabaBailian | 0.13 | 100.0% | -79.7% |
...
| 🥈 | AlibabaBailian | 0.680 | 0.600 | 1.165 |
...
|--------|---------|---------|-----|-----|-----|---------|
| AWSBedrockKB-OpenSearch | 594.57ms | 1486.60ms | 0.61 | 0.800 | 0.800 | 0.631 |
| AWSBedrockKB-Aurora | 711.62ms | 2448.36ms | 0.53 | 0.400 | 0.480 | 0.604 |
| VolcengineVikingDB | 1178.22ms | 1820.70ms | 0.64 | 0.600 | 0.620 | 1.041 |
| AlibabaBailian | 10003.98ms | 11234.43ms | 0.13 | 0.600 | 0.680 | 1.165 |
### 🏆 综合评分对比
...
- **最快响应**: AWSBedrockKB-OpenSearch (P50: 594.57ms)
